...
def opendir(corpus):
    ...
    f_2 = open(os.path.basename(str('slang2.csv')), "r")
    ...
    for i in range(len(hasil5)):
        ...
        if hasil5[i] =="positif" and hasil5[i]==hasil1[i]:
            
            TP1=TP1+1
           
        if hasil5[i] =="negatif" and hasil5[i]==hasil1[i]:
         
            TN1=TN1+1
           
        if hasil5[i] =="netral" and hasil5[i]==hasil1[i]:
            
            TP1=TP1+1
            
        if hasil5[i] =="negatif" and hasil1[i]=="netral":
            
            FP1=FP1+1
            
        if hasil5[i] =="positif" and hasil1[i]=="netral":
            
            FN1=FN1+1
           
        if hasil5[i] =="netral" and hasil1[i]=="positif":
           
            FN1=FN1+1
          
        if hasil5[i] =="netral" and hasil1[i]=="negatif":
    ...
    recall_1=result1[6] *100
    recall_2=result2[6] *100
    recall_3=result3[6] *100
    recall_4=result4[6] *100
    recall_5=result5[6] *100
    recall_6=result6[6] *100
    presisi1=result1[5] *100
    presisi2=result2[5] *100
    presisi3=result3[5] *100
    presisi4=result4[5] *100
    presisi5=result5[5] *100
    presisi6=result6[5] *100
    fig, ax = plt.subplots()
    chart()
    fig.tight_layout()
    plt.show()
